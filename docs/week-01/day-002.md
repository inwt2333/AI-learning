...
新建一个 Python 文件，完成下面三步。

### 实验 A：观察四种规范化形式

对以下字符串打印 `repr()`、码点列表、NFC/NFD/NFKC/NFKD：
...
1. 用一句话定义文本预处理的目标；
2. 画出 NFC/NFD/NFKC/NFKD 的 2×2 对照；
3. 写出你认为“相对安全”和“任务特定”的操作；
4. 粘贴实验 A、B 的关键输出并解释；
5. 分别列出一条中文和英文预处理的特殊风险；
6. 写下一个仍不确定的问题。

我收到后会检查概念、代码输出和表述，再把它整理为 Day 002 笔记。
